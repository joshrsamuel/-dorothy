...
# 1 "q1.h" 1
# 21 "q1.h"
extern const unsigned short q1Bitmap[19200];


extern const unsigned short q1Pal[256];
# 10 "main.c" 2
# 1 "q2.h" 1
# 21 "q2.h"
extern const unsigned short q2Bitmap[19200];


extern const unsigned short q2Pal[256];
# 11 "main.c" 2
# 1 "q3.h" 1
# 21 "q3.h"
extern const unsigned short q3Bitmap[19200];


extern const unsigned short q3Pal[256];
# 12 "main.c" 2
# 1 "q4.h" 1
# 21 "q4.h"
extern const unsigned short q4Bitmap[19200];


extern const unsigned short q4Pal[256];
# 13 "main.c" 2
# 1 "dorothy.h" 1
# 21 "dorothy.h"
extern const unsigned short dorothyBitmap[240];


extern const unsigned short dorothyPal[256];
# 14 "main.c" 2
# 1 "win.h" 1
# 21 "win.h"
...
unsigned short colors[6] = {(((0)&31) | ((0)&31) << 5 | ((0)&31) << 10), (((31)&31) | ((31)&31) << 5 | ((31)&31) << 10), (((31)&31) | ((0)&31) << 5 | ((0)&31) << 10), (((0)&31) | ((31)&31) << 5 | ((0)&31) << 10), (((30)&31) | ((26)&31) << 5 | ((23)&31) << 10), (((15)&31) | ((15)&31) << 5 | ((15)&31) << 10)};
...
void goToGame()
{
    DMANow(3, &dorothyPal, ((unsigned short *)0x5000000), 512 / 2);
    for (int i = 0; i < 6; i++)
    {
        ((unsigned short *)0x5000000)[256 - 6 + i] = colors[i];
    }
...
void goToQ1()
{
    DMANow(3, &q1Pal, ((unsigned short *)0x5000000), 512);
...
void goToQ2()
{
    DMANow(3, &q2Pal, ((unsigned short *)0x5000000), 512);
...
void goToQ3()
{
    DMANow(3, &q3Pal, ((unsigned short *)0x5000000), 512);
...
void goToQ4()
{
    DMANow(3, &q4Pal, ((unsigned short *)0x5000000), 512);
...
void goToWin()
{
    ...
    *(volatile u16 *)0x04000068 = (((5)&15) << 12) | (((7)&7) << 8);
    *(volatile u16 *)0x0400006C = NOTE_C6 | (1 << 15);
    waitForVBlank();
    flipPage();
    state = WIN;
}
...
void goToLose()
{
    ...
    *(volatile u16 *)0x04000068 = (((5)&15) << 12) | (((7)&7) << 8);
    *(volatile u16 *)0x0400006C = NOTE_C2 | (1 << 14) | (1 << 15);
    waitForVBlank();
    flipPage();
    state = LOSE;
}
